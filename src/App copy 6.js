...
function resolveGlobalPractitioner() {
  const gp = (typeof window !== "undefined" && (window.GlobalPractitionerFHIR || window.GlobalPractioner)) || null;
  const fallback = {
    id: `TEMP-${uuidv4()}`,
    name: "Doctor ABC",
        ...
        <div className="card-body">
          ...
          <div className="row g-2">
            <div className="col-md-6">
              ...
              <input name="name" type="text" className="form-control" value={patient.name} readOnly />
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-4 mt-2">
              ...
              <input name="phone" type="tel" className="form-control" value={patient.phone} readOnly />
            </div>
            <div className="col-md-4 mt-2">
